...
- **⓪b 乐观 UI「撤下」改造已完成并入库 (2026-09-21, 提交 `2094a36`)**:
  ...
  - **调查报告** [memory-bank/reports/26-09-20-1806-optimistic-ui-half-fix-report.html](../../reports/26-09-20-1806-optimistic-ui-half-fix-report.html)
    —— 根因与实测留档(bulk 缺真值 / 撤下判据过严 / 真值落地 1362ms)。
  - **可行性报告** [memory-bank/reports/26-09-20-2131-optimistic-ui-event-driven-feasibility.html](../../reports/26-09-20-2131-optimistic-ui-event-driven-feasibility.html)
    （延迟链路拆解 / 通道选型 / 风险）。
  - **⭐ 实施计划（当前以此为准）**
    [memory-bank/plans/26-09-20-2139-webui-truth-direct-query-and-optimistic-removal-plan.html](../../plans/26-09-20-2139-webui-truth-direct-query-and-optimistic-removal-plan.html)
