...
- **真机语料抓取 · 脱敏 · 离线回放 —— W0 已出数, W1/W2 已完成(未提交), 下一步 W3**: 计划
  [memory-bank/plans/26-09-21-0024-qb-corpus-capture-replay-plan.html](../../plans/26-09-21-0024-qb-corpus-capture-replay-plan.html)
  (v1→v3 原地修订) + 审查报告
  [memory-bank/plans/26-09-21-0257-qb-corpus-capture-replay-plan-review.html](../../plans/26-09-21-0257-qb-corpus-capture-replay-plan-review.html)。
