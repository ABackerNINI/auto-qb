...
**1638 collected: 1637 passed + 1 skipped / Windows** —— 2026-09-26 **HR D 档已免罪来源单列 (v3.4 缺口落地)**
(档案 `26-09-22-backend-partial-hr-verify` v3.4; 用户令「修复缺口」)。
**+2 条**: test_hr_resolve.py +2(`test_judge_record_carries_verified_source` D 档放行记录透传
...
TOTAL **92%**(10998 语句 / 787 未覆盖 / 3644 分支 / 328 partial)。
