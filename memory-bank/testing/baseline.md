...
**1177 passed + 1 skipped (Windows 本地, 覆盖率 TOTAL 91%, 7575 语句 / 626 未覆盖) / Linux (WSL 沙箱) 未重测(仍是 1060 passed + 2 skipped)** —— 2026-09-22 实测(config 取值范围收紧 issue 26-09-22-1937 实施后; **数字取自最终树实测**) 
