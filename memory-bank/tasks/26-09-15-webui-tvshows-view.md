...
| ID | 描述 | 状态 | 更新 | 备注 |
|----|------|------|------|------|
| 8.1 | 计划文档 (`memory-bank/plans/26-09-15-1534-webui-shows-view-plan.html`) | Complete | 2026-09-15 | Native 冷峻技术方向 |
