...
| ID | 描述 | 状态 | 更新 | 备注 |
|----|------|------|------|------|
| 2.1 | 调研与计划 (替代 qB 可行性) | Complete | 2026-09-15 | `docs/webui-qb-replacement-plan.html` |
...
| 2.4 | 波次三计划 (30→32 工作项) | Complete | 2026-09-16 | `docs/webui-qb-replace-wave3-plan.html` |
| 2.5 | 波次三盘点与交接 | Complete | 2026-09-17 | `docs/webui-qb-replace-wave3-handover.md` |
