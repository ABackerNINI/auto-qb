...
- **决策 1(文档漂移)**: 按 AGENTS.md 的"代码 > memory-bank"裁决回写, **不动 `docs/plans/` 的历史计划** —— 那份 v3 计划里"重排列集则升 v4→v5"是当时口径的存档, 只在 `activeContext.md` 标注"别照抄"。
...
- `docs/plans/26-09-15-1042-webui-optimization-plan-v3.html` 内"重排列集则升 v4→v5"为当时口径, 存档未改动 —— 后续若有人照抄会误升版本, 已在 `activeContext.md` 标注。
