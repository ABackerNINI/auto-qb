...
- **测试**: `pytest` + `tests/helpers.py` 全 Fake (无需真实 qBittorrent)。当前基线: **684 passed, 覆盖率 90%**(ui.py GUI 本体真机冒烟), 全量运行约 3 秒。
...
.venv/Scripts/python.exe -m pytest tests -q            # 全量 684 项, ~3s
