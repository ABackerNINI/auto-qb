...
- **测试**: `pytest` + `tests/helpers.py` 全 Fake (无需真实 qBittorrent)。当前基线: **706 passed + 1 skipped, 覆盖率 90.2%**(ui.py GUI 本体真机冒烟), 全量运行约 3 秒。
...
.venv/Scripts/python.exe -m pytest tests -q            # 全量 706 项 + 1 skip, ~3s
