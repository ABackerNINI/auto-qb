...
```bash
# 项目 venv (.venv, Python 3.12), 基线: 706 passed + 1 skipped (2026-09-13), 分支覆盖率 90.2%(connect 节流测试因真实网络调用耗时暂时 skip)(ui.py 窗口/托盘本体不单测, 真机冒烟验证)
...
3. 测试粒度小而多 (707 个), 名字用中文/英文短语描述场景。
