...
design card / title-frame / product interstitial. Infer any missing motion
preference from the brief and selected visual direction, then dispatch immediately.
