...
name: web-prototype
description: |
  General-purpose responsive web prototype. Single self-contained HTML file built
...
- **Device reflow must work** across desktop, tablet, and phone preview widths. The seed includes a 920px mobile/tablet breakpoint; don't break it by adding fixed widths.
