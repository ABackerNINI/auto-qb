...
When the user has not provided a pet name, choose a short appropriate name from the pet concept, reference image, or personality, record it as adjustable, and use it consistently as the display name and as the source for the package folder slug.
