...
2. **Resolve auth method** from the user's wording, product context, and existing project patterns; when no signal exists, default to phone/SMS and record the assumption
