...
- **计划产出**: 列计划时使用 `delivery-artifact` skill 产出文档,  将计划文档放入docs/plans/中, 命名统一为"日期-时间-标题", 如"26-09-17-0906-improve-webui-plan", 意思为"26年9月17日上午9点6分的改进webui计划", 方便检索, 注意需通过命令获取当前准确的日期和时间, 不要靠记忆!
